...
public class DataDummy {
    ...
    public static ArrayList<MovieEntity> generateDataMovies() {
        ...
        movies.add(new MovieEntity(
                "682071",
                "/oiFxdnsQyGs3DBLzHzW92GrDR6w.jpg",
        ...
        movies.add(new MovieEntity(
                "920",
                "/qa6HCwP4Z15l3hpsASz3auugEW6.jpg",
                "Cars",
                "Animation",
                "Adventure",
                "117",
    ...
    public static ArrayList<TvShowEntity> generateDataTvShows() {
        ...
        tvShows.add(new TvShowEntity(
                "87784",
                "/JTmkzwSDRiS9nvSPwpDB9fmZj2.jpg",
                "Defending Jacob",
                "Drama",
                "Mystery",
                "1",
